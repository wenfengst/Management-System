...
alltable={'teacher':['teacher',['tid','tname','bank_number','ttime']],
     ...
     'project':['project',['pid','pname','budget','apply','approve','ptime']],
     'class':['class',['cid','pid','tid','cname','time','specific_time','place','specific_place','ctime']],
...
class Apply:
    ...
    def POST(self,pid):
        ...
        form=web.input()
        model.new_item(table,form)
        model.update_project_apply(form['pid'])
        raise web.seeother('/index_project')
